...
function yacheyka_time (id4)
{
id2 = id4;
id3 = 0;
}

function yacheyka_time_end (id5)
{
id3 = id5;
id2 = 0;
}
...
function ($, undefined) {
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            hourText: '4ac',           // Display text for hours section
            minuteText: 'MuHyTa',       // Display text for minutes link
            amPmText: ['AM', 'PM'],     // Display text for AM PM
            closeButtonText: 'KOHEu,',        // Text for the confirmation button (ok button)
            nowButtonText: 'ceu4ac',           // Text for the now button
            deselectButtonText: 'O4uCTuTb'  // Text for the deselect button
        };
...
if (id2==0){
$.post("onclick.php", {id_str_post:id3,prodolg_post:'prodolg'},
function(prodolg_new) {
	$('#prodolg'+id3).text(prodolg_new);
	//alert (prodolg_new);
});
...
if (id3==0){
$.post("onclick.php", {id_str_post:id2,prodolg_post:'prodolg'},
function(prodolg_new) {
	$('#prodolg'+id2).text(prodolg_new);
//alert (prodolg_new);
});
...
//Отвоевал бля, наконец-то		
if (id2==0) 
{
	$.get("onclick.php?prefix=time_end&vr_end="+parsedTime+"&id_str="+id3);
	//alert (parsedTime);
	return parsedTime;
	}

if (id3==0){
$.get("onclick.php?prefix=time_nach&vr_nach="+parsedTime+"&id_str="+id2);
//alert (parsedTime);
return parsedTime;
}
