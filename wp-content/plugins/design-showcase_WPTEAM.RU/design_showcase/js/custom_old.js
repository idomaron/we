// var $my_script =  jQuery.noConflict(); activate this line if you are allready using a different javascript framework like prototype, then change each $ into $my_script in this document
templateurl = "http://www.kriesi.at/demos/wp-content/themes/design_showcase/";
...
function kriesi_noscript(){
	...
	jQuery(".prev_image a").append("<span><img src='"+ templateurl +"images/glas-trans.png' alt='' /></span>");
...
jQuery(document).ready(function(){
	...
	kriesi_tooltip2("a", "tooltip_image2", "title");
	kriesi_footer();
	//template url ned vergessen
});