...
query_posts($query_string . "&cat=-".$kriesi_options['com_cat']);
	...
	if (have_posts()) : $postnumber = 1; ?>
		...
		if($kriesi_options['enable_fav_post']){
					...
					mfp_the_link("add_link=<span class='add_fav'>Добавить в избранное</span>&remove_link=<span class='rem_fav'>Удалить из избранного</span>");						} 
					}
	...
	<?php else : ?>
		...
		<p>Не найдено<br/>
		Извините, но ничего не найдено.</p>
