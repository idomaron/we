...
//***************ADD DROPDOWN CATEGORY TO FORM REGISTRATION*************************//
add_filter('wpmem_register_form_before','add_custom_field_to_form');

function add_custom_field_to_form()
{
		 $str = '<p>This is content that comes before the registration form...</p>'; 
		 
               wp_dropdown_categories('hierarchical=1&hide_empty=0'); 

	    return $str;
}

//***************ADD CUSTOM TAXONOMY TO EVENTS*************************//
...
//add_theme_support( 'post-thumbnails', array( 'post', 'Event' ) ); // Posts and Movies
//
//add_image_size( 'hot Event', 475, 375, true );
//add_image_size( 'Event thumbnail', 230, 180, true );
//
//
...
//    }
//	echo 'users moderation table here'; // that part displeyed 
...
////	 
//
//	 $OrigHtmlOfFieldBefore = '';
//	 $HtmlWithRuleAdded = '';
//	$form = str_replace( $OrigHtmlOfFieldBefore, $HtmlWithRuleAdded, $form );
//	return $form;
//}
//
//
